...
export const MEASUREMENT_WORKFLOWS: readonly MeasurementWorkflow[] = [
  ...
  },
  {
    ...
    description: 'Verify left/right channel routing and detect reversed connections.',
  ...
  {
    id: 'azimuth_crosstalk',
    label: 'Azimuth & crosstalk',
    description: 'Measure channel separation and verify stylus azimuth alignment.',
    requiredAnalyzerModule: 'azimuth_crosstalk',
    fallbackPurposes: ['crosstalk'],
    implementationStatus: 'supported',
