  ...
  return `
    <header class="ea-topbar" aria-label="Primary navigation">
      ...
      <div class="ea-topbar-meta">
        ...
        <button class="ea-help-toggle" type="button" data-help-toggle aria-label="Open help">?<span class="ea-help-indicator-dot" data-help-dot aria-hidden="true"></span></button>
